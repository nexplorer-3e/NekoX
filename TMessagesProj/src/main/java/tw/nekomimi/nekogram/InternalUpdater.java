...
public class InternalUpdater {
    ...
    static final long CHANNEL_METADATA_ID = 1711482056;
    static final String CHANNEL_METADATA_NAME = "none_metadata";
    static final long CHANNEL_APKS_ID = 1711482056;
    static final String CHANNEL_APKS_NAME = "NekoZ_apks";
